...
const Switch = () => {
  ...
  return (
    <button
      ...
      onClick={toggleTheme}
      className={`relative inline-block h-7 lg:h-[37px] w-7 lg:w-[68px] rounded-[30px] shadow-[0_0_10px_rgba(0,0,0,0.1)] transition-colors duration-[350ms] ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-sky-400 overflow-hidden ${
    ...
    >
      ...
      <span
        aria-hidden="true"
        className={`absolute bottom-[8px] left-[8px] flex h-[20px] w-[20px] items-center justify-center rounded-full transition-all duration-[350ms] ease-[cubic-bezier(0.81,-0.04,0.38,1.5)] ${
          isDark
