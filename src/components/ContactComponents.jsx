        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          {inputs.map((input) => (
            <div key={input.id} className="mb-4">
              <input
                ...
                className="font-secondary mt-1 block w-full sm:w-3/4 md:w-1/2 m-auto px-3 py-2 focus:outline-none bg-transparent border-2 main-mode-card main-imputs"
                required
              />
            </div>
          ))}
          <div>
            <textarea
              ...
              onChange={handleChange}
              className="font-secondary mt-1 block w-full sm:w-3/4 md:w-1/2 m-auto px-3 py-2 focus:outline-none bg-transparent border-2 resize-none main-mode-card main-imputs"
              required
            ></textarea>
          </div>
