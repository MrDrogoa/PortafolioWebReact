    ...
    <section className="pt-8 md:pt-12 lg:pt-14 xl:pt-16">
      <div className="flex flex-wrap lg:flex-nowrap md:flex-row justify-center">
        {ideaProcess.map((item, index) => (
          <div
            key={index}
            className="flex flex-col border-2 px-5 md:px-6 py-10 max-w-sm w-full main-mode-card"
          >
            <h3 className="font-primary text-xl md:text-2xl font-semibold main-mode-title">
              {item.step}
            </h3>
            <p
              className="font-secondary font-normal text-sm md:text-lg pb-2 main-mode-paragraph"
