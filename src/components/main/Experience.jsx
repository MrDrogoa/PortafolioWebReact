    ...
    <section className="max-w-[1300px] m-auto pt-8 sm:pt-10 md:pt-30 px-4">
      ...
      <div className="flex flex-col md:flex-row flex-wrap justify-center px-5 w-full">
        {experienceData.map((experience, index) => (
          <div
            key={index}
            className="flex flex-col border-3 px-3 py-6 sm:px-4 md:py-8 md:px-6 lg:py-10 lg:px-8 gap-3 max-w-sm m-auto md:m-0 main-mode-card"
          >
            <h3 className="font-primary text-lg sm:text-xl md:text-2xl font-semibold main-mode-title">
              {experience.title}
            </h3>
            ...
            <p className="font-secondary font-normal text-sm md:text-lg main-mode-paragraph">
              {experience.paragraph}
            </p>
            <div className="flex justify-end"></div>
            <Link
              to={experience.path}
              className="flex justify-end mt-auto main-mode-button"
            >
