...
function ExperienceComponents() {
  return (
    <section className="max-w-[1300px] m-auto px-4 lg:px-0">
      ...
      <p className="font-secondary text-white font-medium mt-4 md:mt-5 lg:mt-6 w-full sm:w-[90%] md:w-[80%] lg:w-[70%] xl:w-[60%] m-auto text-center md:text-lg main-mode-paragraph">
