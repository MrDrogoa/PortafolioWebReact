# 📘 Guía de Uso - Cómo agregar tus proyectos y conectar con React

Esta guía te explica paso a paso cómo subir tus 9 proyectos a la base de datos y consumir la API desde tu aplicación React.

---

## 📋 Tabla de Contenidos
1. [Preparar la Base de Datos](#1-preparar-la-base-de-datos)
2. [Subir tus Proyectos](#2-subir-tus-proyectos)
