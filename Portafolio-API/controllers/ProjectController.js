...
class ProjectController {
  ...
  static async update(req, res) {
    try {
      ...
      const projectData = {
        titulo: titulo || existingProject.titulo,
        descripcion: descripcion || existingProject.descripcion,
        categoria: categoria || existingProject.categoria,
        tecnologias: tecnologias || existingProject.tecnologias,
        github_url:
          github_url !== undefined ? github_url : existingProject.github_url,
        demo_url: demo_url !== undefined ? demo_url : existingProject.demo_url,
        orden: orden !== undefined ? orden : existingProject.orden,
  ...
  static async hardDelete(req, res) {
    try {
      const { id } = req.params;
      const deleted = await ProjectModel.hardDelete(id);
